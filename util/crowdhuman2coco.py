# modified from https://github.com/Asthestarsfalll/CrowdHuman/blob/main/crowdhuman2coco.py
...
def crowdhuman2coco(args, odgt_path, json_path, data_path):
    ...
    for image_id, image_dict in enumerate(records):
        ...
        for _, instance in enumerate(gt_box):
            ...
            if args.full:
                ...
                area = instance['fbox'][2] * instance['fbox'][3]
            if args.visible:
                attr = instance['extra']
                if args.rm_occ and attr['ignore']:
                    continue
                annotation['vbox'] = instance['vbox']
                area = instance['vbox'][2] * instance['vbox'][3]
            if args.head:
                ...
                area = instance['hbox'][2] * instance['hbox'][3]
    ...
    for cate, cid in categories.items():
        if cate == args.tag or 'both' == args.tag:
            cat = {
                # 'supercategory': cate,
                'id': cid,
                'name': cate
